...
public class KeywordSplitter 
{
	public static void main(String[] args) 
	{
		try
		{
			FileInputStream file = new FileInputStream(new File("test5.xlsx"));
					...
					if(i==3)
                  	...
                  	try{
                           ...
                           while (st.hasMoreTokens()) {  
                        	   ...
                        	   if(temp!=null&&temp!=" ")
                        	   data.put(String.valueOf(j++), new Object[] {id,pc,sc,temp});
                           }  
			...
			try 
			{
			    ...
			    FileOutputStream out = new FileOutputStream(new File("test6.xlsx"));
			    work.write(out);
